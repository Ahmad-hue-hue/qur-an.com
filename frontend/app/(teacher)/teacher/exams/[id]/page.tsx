...
export default function AdminExamDetailPage({
  ...
  const { data: submissions } = useQuery({
    queryKey: ["teacher-exam-submissions", examId],
    queryFn: () => teacherApi.getExamSubmissions(examId),
  ...
  const saveQuestionMutation = useMutation({
    mutationFn: () => {
      ...
      if (editingQuestionId) {
        return teacherApi.updateExamQuestion(examId, editingQuestionId, payload);
      }
      return teacherApi.addExamQuestion(examId, payload);
    },
    onSuccess: () => {
  ...
  const deleteQuestionMutation = useMutation({
    mutationFn: (questionId: number) =>
      teacherApi.deleteExamQuestion(examId, questionId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["teacher-exam", examId] });
      ...
      <div className="page-content">
        ...
        {exam && (
          <>
            ...
            <Link href={`/teacher/exams/${examId}/submissions`}>
