-- Feature: tadreeb marks are now recorded for Marḥalah 1 too, same as
-- ḥalaqah (20260811100000_marhalah1_halaqah_scores.sql added ḥalaqah to M1
-- but deliberately left tadreeb excluded). Ḥalaqah and tadreeb are now
-- symmetric across every Marḥalah.
...
-- maybe_promote_student: tadreeb is now required for every marhalah, same as ḥalaqah.
