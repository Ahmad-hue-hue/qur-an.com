-- Widen roster RPC arg to integer for PostgREST/JS callers.

drop function if exists public.get_marhalah_results_roster (smallint);
...
revoke all on function public.get_marhalah_results_roster (integer) from public, anon;
grant execute on function public.get_marhalah_results_roster (integer) to authenticated, service_role;
